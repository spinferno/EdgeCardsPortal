function OrderCreateStep4BusinessLogic() {
    ...
    var content = '<b>Edge Order Number:    ' + orderNumber + '</b></br></br>Thank you for submitting your Order to Edge. Please note down the above order number for your own records.</br></br>An Invoice will be generated for this Order and sent to you, Once the Invoice is Paid the Order will be actioned by our team</br></br>In case of any queries regarding this Order, please contact Edge Pty Ltd Support on (03) 8391 3226 or email <a href = "mailto: production@edgepri.com">production@edgepri.com</a>.';
